...
<div class="col-3">
  <div>
    ...
    <input class="form-control form-control-sm" type="file" (change)="file($event)">
  </div>
</div>
<div class="col-3">
  <button (click)="cng()" type="button" class="btn btn-primary btn-sm">change data</button>
</div>
<div class="col-1">

  <input type="range" class="form-range" min="0.5" max="1.5" step="0.1" value="0.5" (change)="customRange1($event)">
</div>
